...
import Cprogram from './src/CProgram/Cprogram';
import Python from './src/Python/Python';
import Java from './src/Java/Java';
import SQL from './src/SQL/SQL';
import CPlus from './src/C++/CPlus';
import Javascript from './src/Javascript/Javascript';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name="C" component={Cprogram} />
